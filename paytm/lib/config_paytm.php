...
if (PAYTM_ENVIRONMENT == 'TEST') {
	...
	$PAYTM_MERCHANT_MID 		= "UvaLxt93516792108659";
	$PAYTM_MERCHANT_KEY 		= "UfnfTQdcfwHZiSma";
	...
	//Change this constant's value with Merchant key received from Paytm.
	$PAYTM_MERCHANT_MID 		= "mMoNZx20253390024506";
	$PAYTM_MERCHANT_KEY 		= "dAR4ZA3h8p8L&O%N";

	$PAYTM_CHANNEL_ID 		= "WEB";
	$PAYTM_INDUSTRY_TYPE_ID = "Retail";
	$PAYTM_MERCHANT_WEBSITE = "WEBSTAGING";

	$PAYTM_CALLBACK_URL 	= "http://localhost/second-hand-book/paytm//response.php";
